                    ...
                    <div className="flex justify-center gap-3">
                      ...
                      {cat.status === "Active" && (
                        <button
                          ...
                          className="p-2 rounded-lg bg-red-100 text-red-600 hover:bg-red-200 hover:text-red-700 transition"
                        >
                          <FaTrash />
                        </button>
                      )}
        ...
        <div className="flex justify-between items-center p-4 border-t border-gray-100">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1 border rounded-xl disabled:opacity-50 transition"
            >
              Prev
            </button>
            <button
